...
from PJ0_NumeriskIntegrasjon.PF0_Plott_1 import CentiLiter
...
filenameMeas = "Meas_PJ0_TidLys_2.txt"
...
filenameCalcOnline = "CalcOnline_PF0_EgneVariabler_2.txt"
# --------------------------------------------------------------------
...
def main():
    try:
        ...
        Ts = [0]             # tidsskritt
        DiffLys = []        # vil vel også bli tidsskrittet?
        SumDiffLys = []
        CentiLiter = []
        ...
        while True:
            ...
            if len(filenameCalcOnline)>4:
                if k == 0:
                    ...
                    CalculationsToFileHeader += "2=Ts, 3=CentiLiter \n"
                ...
                CalculationsToFile += str(CentiLiter[-1]) + "\n"
            ...
            if wired:
                ...
                DataToOnlinePlot["CentiLiter"] = (CentiLiter[-1])
...
def MathCalculations(Tid:list,Lys:list,DiffLys:list,SumDiffLys:list,Ts:list):
    
    # Parametre
    CentiLiter.append(Lys[-1])
